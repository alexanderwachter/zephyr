...
/*
 * This is a partial implementation of the C++ std lib cxa handlers
 * It only implements functions for std::terminate, because some libraries
 * rely on the fact that std::terminate is available.
 */
