 ...
 *             };
 *
 * In C++, expressions like this which take the address of a temporary
 * are illegal to use as function arguments. If you need to pass the
 * pointer to a function in C++, do something like this:
 *
 *         auto ctrl = *SPI_CS_CONTROL_PTR_DT(...);
 *         foo(..., ctrl, ...);
 *
